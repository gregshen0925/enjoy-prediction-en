...
const Friends: NextPage = (props: Props) => {
    return (
        <div className='pt-10'>
            <div className='text-white font-bold max-w-xl'>之前EthOnline Hackathon有投稿一個 Web 交友 App，結合 DID, Soulbound Token, Tokenized Relationship等等概念，
                得獎後有獲得IPFS團隊的資源，我們想把這個功能應用在 EnJoy Prediction 上，增添更多樂趣</div>
